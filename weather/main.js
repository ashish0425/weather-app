...
async function weatherReport(searchCity) {
    ...
    weatherApi = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=260aa10daefd402b85e170740231907&q=${searchCity}&days=7&aqi=yes&alerts=no`);
